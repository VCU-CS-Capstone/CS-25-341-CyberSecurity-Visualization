...
* Got RFID authentication working on the Raspberry Pi servers. The system has been tested and functions as expected. - Calvin
...
* Begin running the attacks on the network - Calvin
* Test the DOS and maybe the brute force attack if no issues - Chris
* Fix the errors and permissions, put everything into one file, and send it over to the team for project use - Jaspreet
